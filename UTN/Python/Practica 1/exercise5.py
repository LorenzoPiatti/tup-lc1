...
# COMPLETAR - INICIO
string_01 = "¡Mamá "
string_02 = "estoy concatenando "
string_03 = "strings!"
frases = [string_01, string_02, string_03]
strings_concatenados = "".join(frases)
print(strings_concatenados)
# COMPLETAR - FIN
...
frases = [variable_01, variable_02, variable_03]
strings_concatenados = "".join(frases)
print(strings_concatenados)
# COMPLETAR - FIN
...
print(f"{strings_concatenados.title()}")
# COMPLETAR - FIN
