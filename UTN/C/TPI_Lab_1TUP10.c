...
void realizarTransferenciaEntreCuentas(struct Cliente clientes[])
{
    ...
    do
    {
        ...
        {
            printf("El n%cmero de cuenta ingresado no se encontro o ingresaste tu numero de cuenta.\n", 163);
            do
            {
        ...
        else
        {
            do // Valido el monto que quiere transferir que no sea menor a cero y que sea menor que el saldo del cliente
            {
                ...
                {
                    printf("Mont%c ingresado no v%clido.\n", 162 , 160);
                }
...
void main()
{
    ...
    struct Cliente clientes[10] =
        {
            // numeroCuenta, contrasena, nombre, saldo, estado
